...
final class Version20210306231315 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE assessment_question (id INT AUTO_INCREMENT NOT NULL, question_id INT NOT NULL, assessment_id INT NOT NULL, INDEX IDX_CA8158684FAF8F53 (question_id), INDEX IDX_CA8158687660A141 (assessment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE assessment_question ADD CONSTRAINT FK_CA8158684FAF8F53 FOREIGN KEY (question_id) REFERENCES question (id)');
        $this->addSql('ALTER TABLE assessment_question ADD CONSTRAINT FK_CA8158687660A141 FOREIGN KEY (assessment_id) REFERENCES assessment (id)');
    }
